...
// EN PAUSA desde la migración a GOAL API (ver CHANGELOG.md y
// api/_lib/proveedorApiFootball/partidos.js para el motivo completo) —
// no enlazado a ninguna ruta activa, se conserva completo por si la
// cuenta de API-Football se reactiva. El endpoint activo hoy es
// api/jugadores.js (llama a GOAL API), comparte la misma tabla
// "plantillas_equipos" (columna equipo_id ahora "text", acepta tanto
// ids numéricos de API-Football como los ids-string de GOAL).
//
// --- Comentarios originales, tal cual ---
//
