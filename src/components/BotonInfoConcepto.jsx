...
export default function BotonInfoConcepto({ conceptoId, etiqueta }) {
  ...
  return (
    <>
      ...
      {/* Portal a document.body: este botón puede vivir dentro de un panel
          lateral que anima con "transform" (p.ej. PanelEstadisticas.jsx),
          lo que convierte a ese antecesor en el "contenedor" de cualquier
          descendiente "position: fixed" — sin portal este recuadro se vería
          mal posicionado en vez de centrado en toda la ventana (mismo bug ya
          resuelto en SelectorDesplegable.jsx). */}
      {abierto &&
        createPortal(
          <div
